...
function Precios() {
  const priceSections: PriceSection[] = [
    ...
    },
    {
      ...
      items: [
        {
          service: "Pelo Corto - Tratamiento Antiencrespamiento",
          price: "102€",
        },
        {
          service: "Pelo Corto - Tratamiento Ácido Hialurónico",
          price: "102€",
        },
        {
          service: "Pelo Medio - Tratamiento de Antiencrespamiento",
          price: "152€",
        },
        {
          service: "Pelo Medio - Tratamiento Ácido Hialurónico",
          price: "202€",
        },
        {
          service: "Pelo Largo - Tratamiento de Antiencrespamiento",
          price: "202€",
        },
        {
          service: "Pelo Largo - Tratamiento Ácido Hialurónico",
          price: "252€",
        },
        {
          service: "Tratamiento Alisado Extra-Largo Ácido Hialurónico",
          price: "302€",
        },
      ],
    },
    ...
    },
    {
      ...
      items: [
        ...
        { service: "Lavado Curly", price: "14€" },
        {
          ...
          price: "22€",
          description:
            "Sistema de hidratación en tres pasos para recuperar el cabello de los tratamientos químicos evitando la rotura.",
        },
        {
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="prose prose-lg mx-auto mb-12 text-center">
              <p className="text-muted-foreground">
                Te ofrecemos nuestra extensa experiencia para ayudarte a
                encontrar lo que necesitas, además de disfrutar de una agradable
                experiencia.
              </p>
              <p className="text-muted-foreground mt-4">
                Para nosotros cada persona es única ya que busca un estilo único
                para ella misma, por eso os ofrecemos tratamientos
                personalizados.
              </p>
              <p className="text-sm text-muted-foreground mt-4">
                Los precios detallados son aproximados, para un presupuesto
                cerrado hay que acudir el salón, ya que los presupuestos son
                personalizados.
              </p>
            </div>
